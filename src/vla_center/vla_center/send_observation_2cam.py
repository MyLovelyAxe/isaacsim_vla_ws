...
class VLAObservationSender2CamNode(Node):
    def __init__(self):
        ...
        self.sync = ApproximateTimeSynchronizer(
            [self.cam1_sub, self.cam2_sub, self.joint_sub],
            queue_size=10,
            slop=0.02,
        )
    ...
    def callback_observation(        
        ...
        :param cam2_msg: image from simulated camera 2
    ...
    def pack_observation(
        ...
        :param img1_bytes & img1_bytes: bytes of camera 1 & 2 image
        ...
        np.savez_compressed(
            ...
            img2_encoded=np.array([1 if encoded_flag else 0], dtype=np.int8),
        )
        return buf.getvalue()
